...
* `https://github.com/tyrantlink/caddy-security` => `https://github.com/anonymous/caddy-security`
...
Next, modify `go.mod` in `github.com/tyrantlink/caddy-security`. Include
...
```
module github.com/tyrantlink/caddy-security
...
```bash
        @mkdir -p ../xcaddy-$(PLUGIN_NAME) && cd ../xcaddy-$(PLUGIN_NAME) && \
                ...
                --with github.com/tyrantlink/caddy-security@$(LATEST_GIT_COMMIT)=$(BUILD_DIR) \
